...
Status bar is located at the bottom of the screen. It shows your current and maximum stamina, current and maximum altitude on this terrain, and status message. Everything apart the status bar is the map shown via top-down view.
